...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // In NextAuth.js, for email signup, we use the same signIn method
      // as login but this sends a verification email for new users
...
export const metadata = {
  title: 'Sign Up - FitJournal',
  description: 'Create a new FitJournal account and start tracking your fitness journey',
};
